...
struct PriorityQueue
{
    ...
    bool is_member(Node* n)
    {
        ...
        {
            if (n->cell.x == node->cell.x && n->cell.y == node->cell.y) return true;
        }
        return false;
    }
    ...
    Node* get_member(Node* n)
    {
        for (auto &&node : elements)
        {
            if (n->cell.x == node->cell.x && n->cell.y == node->cell.y) return node;
        }
        return NULL;
    }
    ...
    Node* pop()
    {
        ...
        {
            if (n->cell.x == elements.at(i)->cell.x && n->cell.y == elements.at(i)->cell.y)
            {
                idx = i;
                break;
            }
